...
Before you open anything, please read the [contribution guide](https://github.com/GuavaCZ/filament-icon-picker/blob/main/.github/CONTRIBUTING.md) in the repository.

## Reporting a bug

Bugs belong in the [issue tracker](https://github.com/GuavaCZ/filament-icon-picker/issues/new?template=bug.yml).
...
2. The code of the field or column you are having trouble with
...
Feature requests are handled as [discussions](https://github.com/GuavaCZ/filament-icon-picker/discussions/new?category=ideas) instead of issues, so other users can chime in and tell us whether they need it too.
...
If something is unclear and you are not sure it's a bug, please use the [Q&A discussions](https://github.com/GuavaCZ/filament-icon-picker/discussions/new?category=q-a).

## Reporting a security issue

Please do **not** open a public issue for security problems.

If you discover a security related issue, send an email to office@guava.cz instead. More details in our [security policy](https://github.com/GuavaCZ/filament-icon-picker/security/policy).
