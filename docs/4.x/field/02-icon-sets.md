...
> [!NOTE]
> Some kits are very large. If you install several of them, please read the note about the livewire payload size on the [installation](../02-installation.md) page.
