...
Both 4.x and 5.x run on filament 5. 5.x is the recommended version, it loads icons over its own endpoints instead of livewire. See [upgrading](03-upgrading.md).
